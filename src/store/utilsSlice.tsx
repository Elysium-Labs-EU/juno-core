...
const utilsSlice = createSlice({
  ...
  reducers: {
    ...
    setSettings: (state, { payload }: PayloadAction<Record<string, string | boolean | number>>) => {
      state.activeModal = payload.showIntroduction ? global.ACTIVE_MODAL_MAP.intro : null
