...
import {
  ...
  gmailV1SchemaMessagePartHeaderSchema,
  gmailV1SchemaMessagePartSchema,
...
export const ComposeEmailReceiveSchema = z.object({
  ...
  files: z.array(gmailV1SchemaMessagePartSchema, z.instanceof(File)).nullable().optional(),
...
export const ComposeEmailConvertedSchema = z.union([
  z.array(Contact),
  z.array(
    z.object({
