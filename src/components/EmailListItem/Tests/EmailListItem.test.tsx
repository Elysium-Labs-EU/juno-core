...
describe('EmailListItem regular tests', () => {
  ...
  test('should always show an avatar', () => {
    renderWithProviders(<EmailListItem email={testEmail} showLabel={false} index={0} activeIndex={0} />)
...
describe('EmailListItem draft tests', () => {
  test('should render a recipient name if email is a draft', () => {
    renderWithProviders(<EmailListItem email={testDraftEmail} showLabel={false} index={0} activeIndex={0} />)
